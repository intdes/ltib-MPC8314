...
./configure --prefix=%{_prefix} --host=$CFGHOST --build=%{_build} \
            --enable-composite  --enable-kdrive --disable-dri --disable-xinerama --disable-xf86misc --disable-xf86vidmode --disable-xorg --disable-xorgcfg --disable-xnest --disable-xvfb --disable-xevie --disable-xprint --disable-xtrap --enable-xfbdev  --disable-dmx --disable-builtin-fonts --disable-dbus --disable-glx --with-default-font-path=built-ins $extra_opts
